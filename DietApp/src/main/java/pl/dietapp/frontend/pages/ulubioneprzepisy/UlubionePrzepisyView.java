package pl.dietapp.frontend.pages.ulubioneprzepisy;
...
@PageTitle("Ulubione Przepisy")
@Tag("ulubione-przepisy-view")
@JsModule("./views/ulubioneprzepisy/ulubione-przepisy-view.ts")
public class UlubionePrzepisyView extends LitTemplate implements HasComponents, HasStyle {

    @Id
    private Select<String> sortBy;

    public UlubionePrzepisyView() {
        addClassNames("ulubione-przepisy-view", "flex", "flex-col", "h-full");
